...
const Aboutus = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden py-10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-black mb-4 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent animate-gradient">
            Meet Our Team
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#151515] p-6 rounded-2xl border border-gray-800/50 text-center">
            <div className="text-4xl font-bold text-purple-400 mb-2">4</div>
            <div className="text-gray-400">Team Members</div>
          </div>
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#151515] p-6 rounded-2xl border border-gray-800/50 text-center">
            <div className="text-4xl font-bold text-blue-400 mb-2">24/7</div>
            <div className="text-gray-400">Hackathon Mode</div>
          </div>
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#151515] p-6 rounded-2xl border border-gray-800/50 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            <div
              key={member.id}
              className="group relative bg-gradient-to-br from-[#1a1a1a] to-[#151515] p-6 rounded-2xl border border-gray-800/50 shadow-xl transform transition-all duration-300 hover:scale-[1.02] hover:border-gray-700/50"
              style={{
              ...
              <div className="relative z-10">
                ...
                <div className="relative mb-4">
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-32 h-32 mx-auto rounded-full border-4 border-gray-700 group-hover:border-purple-600/50 transition-all duration-300"
                  />
                  <div className="absolute inset-0 w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-purple-600/20 to-blue-600/20 blur-xl group-hover:blur-2xl transition-all duration-300"></div>
                </div>
                ...
                <p className="text-sm text-purple-400 mb-3 text-center font-medium">
                  {member.role}
                </p>
        ...
        <div className="mt-20 text-center">
          <div className="inline-block bg-gradient-to-r from-purple-600 to-blue-600 p-[2px] rounded-2xl">
            <div className="bg-[#0a0a0a] px-8 py-4 rounded-2xl">
